...
<body ng-controller="ShopMeCtrl" ng-init="loadAllProducts()">
<nav>
  <div class="container"> 
...
<hr>
<div class="container" >
  <div class="row text-center" ng-repeat="products in productsFull" ng-init="outerIndex=$index">
    <div class="col-sm-4 col-md-4 col-lg-4 col-xs-6" ng-repeat="product in products" ng-init="innerIndex=$index">
      <div class="thumbnail"> <img src="{{product.imageUrl}}" alt="Thumbnail Image 1" class="img-responsive">
        <div class="caption">
          <h3>{{product.name}}</h3>
          <p>{{product.color}} - {{product.name}} for {{product.price}}</p>
          <p><a href="#" class="btn btn-primary" role="button" ng-click="setProductToLocal(outerIndex, innerIndex)"><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span> Add to Cart</a></p>
        </div>
      </div>
    </div>
    </div>
